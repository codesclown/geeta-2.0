...
/**
 * BackCoverPage — back cover matching the front cover style.
 */
  ...
  ({ totalChapters }, ref) => {
    return (
      <div
        ...
        style={{
          background: "linear-gradient(160deg, #78350f 0%, #92400e 50%, #7c2d12 100%)",
        }}
      >
        {/* Frames */}
        ...
        <div className="shrink-0 pb-6 text-center z-10">
          ...
          <p className="devanagari text-amber-600/40 text-sm">
